...
int main()
{
    string dataBaru[3] = {"202201001", "Lukas Krisna", "Sistem Informasi"};
    createCircularSingleLinkedList(dataBaru);

    printCircular();

    string data[3] = {"202201002", "Lorem Ipsum", "Teknik Informatika"};
    addFirst(data);

    printCircular();

    string data2[3] = {"202201003", "Dolor Sit", "Teknik Perminyakan"};
    addLast(data2);

    printCircular();

    string data3[3] = {"202201004", "Sit Amet", "Teknik Elektro"};
    addMiddle(data3, 5);
