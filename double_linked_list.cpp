...
int main()
{
    ...
    string newData[4] = {"Lorem Ipsum", "loremipsum", "loremipsum@gmail.com", "LOREMIPSUM"};
    createDoubleLinkedList(newData);

    printDoubleLinkedList();

    string data2[4] = {"Lorem", "lorem", "lorem@gmail.com", "LOREM"};

    addFirst(data2);

    printDoubleLinkedList();

    string data3[4] = {"Ipsum", "ipsum", "ipsum@gmail.com", "IPSUM"};

    addLast(data3);

    printDoubleLinkedList();

    string data4[4] = {"Ipsum Lorem", "ipsumlorem", "ipsumlorem@yahoo.com", "IPSUMLOREM"};
    addMiddle(data4, 3);
